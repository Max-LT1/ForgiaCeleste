...
document.addEventListener("DOMContentLoaded", () => {
   ...
   const modifyForm = document.getElementById("modifyform");
    ...
    if (modifyForm) {
        inizializzaModify(modifyForm);
    }

});

function inizializzaModify(form) {
    ...
    const passwordInput = form.querySelector('input[name="passwordAttuale"]');
    const nuovaPasswordInput = form.querySelector('input[name="NuovaPassword"]'
    );
