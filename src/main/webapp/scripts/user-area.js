...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (modifyForm) {
        inizializzaModificaDatiUtente(modifyForm);
    }
});


function inizializzaModificaDatiUtente(form) {
    ...
    const passwordInput = form.querySelector('input[name="currentPassword"]');
    const nuovaPasswordInput = form.querySelector('input[name="newPassword"]');
    const confermaNuovaPasswordInput = form.querySelector('input[name="confirmNewPassword"]');

    aggiungiIndicatorePassword(nuovaPasswordInput);
